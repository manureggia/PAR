...
Funziona sulla base di informazioni inviate esplicitamente attraverso il campo header denominato [[4. Livello trasporto#Header |Window Size]]:
...
- **Controllo congestione assistito** --> nel [[3. Livello Network#Header IP |tos]] è presente un bit ECN che i router mandano in caso di congestione
